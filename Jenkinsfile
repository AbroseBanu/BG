pipeline {
    ...
    stages {
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'bankapp-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://4F21F5C2F6A8F9FC5B7921B8645BDBB2.gr7.ap-south-1.eks.amazonaws.com') {
